...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col gap-16 md:gap-24 pb-24 overflow-hidden">
      ...
      {/* ── Hero Section ───────────────────────────────────────────── */}
      <section className="relative z-10 px-4 sm:px-6 lg:px-8 pt-8 sm:pt-16 max-w-7xl mx-auto text-center w-full">
        ...
        <h1
          className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-neutral-100 max-w-4xl mx-auto leading-[1.12]"
        ...
        <p
          className="mt-6 text-base sm:text-lg text-neutral-400 max-w-2xl mx-auto leading-relaxed"
        ...
        >
          <Link
            href="/events"
            className="inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-semibold bg-[#E5E5E5] text-neutral-950 hover:bg-white shadow-sm active:scale-[0.98] transition-all duration-200 card-lift"
          >
          ...
          <Link
            href="/about"
            className="inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-medium text-neutral-200 bg-white/[0.03] border border-white/10 hover:border-white/20 hover:bg-white/[0.07] transition-all duration-200 backdrop-blur-md"
          >
        ...
        <div
          className="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto"
          style={{ animation: "pageFadeIn 400ms 240ms cubic-bezier(0.16,1,0.3,1) both" }}
        >
          <Link
            href="/members"
            className="p-6 rounded-3xl glass-card border border-white/[0.06] hover:border-white/20 hover:bg-white/[0.03] text-center transition-all duration-200 shadow-xl group block card-lift"
          >
            <div className="flex items-center justify-center gap-2.5 mb-1">
              <div className="p-2.5 rounded-2xl bg-white/[0.06] text-neutral-300 group-hover:scale-110 transition-transform duration-200">
