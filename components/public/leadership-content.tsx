...
interface LeadershipContentProps {
  initialMembers?: import("@/lib/mock-data").ClubMember[];
}

export function LeadershipContent({ initialMembers }: LeadershipContentProps = {}) {
  const { members: allMembers, loading } = useMembers("all", "all", "", initialMembers);
