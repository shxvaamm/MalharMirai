...
export const metadata: Metadata = {
  ...
  icons: {
    // Keep PNG for favicon — WebP not universally supported in browser tab icons
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark scroll-smooth" suppressHydrationWarning>
      <head>
        {/* Preload the navbar wordmark — always above-fold on every route (fixed header).
            WebP version: 31 KB vs 388 KB original PNG. mirai-logo (8 KB) and
            malhar-logo are not above-fold on most routes so no preload needed. */}
        <link rel="preload" href="/images/malhar-wordmark.webp" as="image" type="image/webp" />
